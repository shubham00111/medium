...
// .wrangler/tmp/bundle-HY0tOR/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Shubham\\OneDrive\\Desktop\\Projects\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "a338c7edaa14a319aa1e01efc93cb6677df5ca493c2c9e137828236ea9fb4e49",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-HY0tOR/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-HY0tOR/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.use("/api/v1/blog/*", async (c, next) => {
  ...
  const response = await verify2(header, secretPasscode);
  if (response.email) {
    next();
  } else {
    return c.json({
...
app.post("/api/v1/signup", async (c) => {
  ...
  const token = await sign2(user, secretPasscode);
  return c.json({
    token
  });
});
